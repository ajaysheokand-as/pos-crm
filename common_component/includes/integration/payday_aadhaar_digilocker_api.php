...
function digilocker_create_url_api_call($method_id, $lead_id = 0, $request_array = array()) {
    ...
    try {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => '{
            "signup": true,
            "redirectUrl": "https://lms.paisaonsalary.in/aadhaar-veri-response?refstr=' . $lead_id . '",
            "redirectTime": "1",
            "callbackUrl": "https://lms.paisaonsalary.in/aadhaar-veri-response?refstr=' . $lead_id . '",
            "customerId": "<customer ID>",
            "successRedirectUrl": "https://lms.paisaonsalary.in/aadhaar-veri-response?refstr=' . $lead_id . '",
