...
$headers = array(
    ...
    "apikey: ZpMzcI0BmDXGJYpX8qSQGsrhPAG9mBa1",
    "x-priority: 1000"
);
...
*/
 ...
 $reques_params = [
     "localTxnDtTime" => "20250618162130",
     "beneAccNo" => "123456041",
     "beneIFSC" => "NPCI0000001",
     "amount" => "1.00",
     "tranRefNo" => "ttrrrrestingranstte",
...
//print_r($apostData);
//echo '</br>';
$sessionKey = 1234567890123412; //hash('MD5', time(), true); //16 byte session key
...
$iv = 1234567890123412; //str_repeat("\0", 16);
