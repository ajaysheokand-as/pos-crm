...
abstract class REST_Controller extends \CI_Controller {
    ...
    protected function _token() {
        ...
        return $tokens = [
            "token_Leads" => md5("ks-digital-journey-android-app-2024"), // Y2M0Nzk0OGYwNmQyMjdmZTlhY2E1ZWQ1Nzk5YTZmMWE=
            //            "token_Leads" => md5("S-370-Engineer_Vinay-Kumar_LW_Paday"), // 3276a0fb51cf161d147bc14b4f0a1749
            "token_Docs" => md5("S-370-Engineer_Vinay-Kumar_LW_Paday"), // 3276a0fb51cf161d147bc14b4f0a1749
            "token_chatbot" => md5("chat_bot_20220509_yellowai"), // bed4715b5d5c9616a7d6e0983448dea1
            "token_android" => md5("Kasar@2024@@!AndroidJourney"), // ZTI4MTU1MzE4NWQ2MGQyZTFhNWM0NGU3M2UzMmM3MDM=
            "token_ios" => md5("Kasar@2024@@!IOSJourney"), // ZTI4MTU1MzE4NWQ2MGQyZTFhNWM0NGU3M2UzMmM3MDM=
            "repayment" => md5("Kasar@2024%repayment1"), // MjFmMTdiYjE0MTM3Y2YxODQxYjhiMGEwNTY4M2I1ZDE=
        ];
    }
    ...
    protected function _log_request($authorized = FALSE) {
        ...
        $request_data = json_decode($log_insert_array['params'], true);

        if (isset($request_data['lead_id']) && !empty($request_data['lead_id'])) {
            $log_insert_array['lead_id'] = $request_data['lead_id'];
        }

        $is_inserted = $this->rest->db->insert($this->config->item('rest_logs_table'), $log_insert_array);
     ...
     */
    protected function _log_response_code($http_code, $output = null) {

        $payload['response_code'] = $http_code;
        $payload['response_datetime'] = date("Y-m-d H:i:s");
        if (!empty($output)) {
            $payload['response_params'] = $output;
        }
