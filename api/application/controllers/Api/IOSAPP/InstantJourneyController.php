...
class InstantJourneyController extends REST_Controller {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && $header_validation) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (in_array($app_name, array("SPEEDO"))) {
                    ...
                    if ($version == $current_version || $version == '3.0.0') { // || $version == '3.0.0'
    ...
    public function getDashboardData_post() {
        ...
        try {
            ...
            if (in_array($lastleaddetails['lead_status_id'], [8, 9, 16, 17, 18, 41, 42, 1, 4])) {
