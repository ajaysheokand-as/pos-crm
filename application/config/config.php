...
$config['base_url'] = getenv('WEBSITE_URL') ?? 'https://cms.paisaonsalary.in/';
...
if (isset($_SERVER["REQUEST_URI"])) {
  ...
  $excluded_routes = array(
      ...
      '/api/taskapi/savelendingpage',
      '/api/taskapi/savelendingpageotpverify',
      '/api/taskapi/userregistration',
      '/api/taskapi/userverification',
      '/api/taskapi/vinsavetasks',
      '/api/taskapi/getsaveleads',
