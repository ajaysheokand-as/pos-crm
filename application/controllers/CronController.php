                                        ...
                                        <div class="email-container">
                                            <div class="email-content">
                                                <table class="header" width="100%">
                                                    <tr>
                                                        <!--<td  class="left-top"><img src="'.(getenv("WEBSITE_URL") ?? 'https://cms.paisaonsalary.in/').'public/images/Kasar_background.png" alt="Left Banner"></td>-->
                                                        <td  class="left-top">Aman Fincap Ltd.</td>
                                                         <td class="right-top" ></td>
                                                    </tr>';
            if (isset($return_sms['days_until_repayment']) && ($return_sms['days_until_repayment'] < 1)) {
                $message .= '<tr>
                                                        <td class="left-banner"><img src="'.(getenv("WEBSITE_URL") ?? 'https://cms.paisaonsalary.in/').'public/images/important-reminer.png" alt="Important Reminder"></td>
                                                        <td class="right-banner"><img src="'.(getenv("WEBSITE_URL") ?? 'https://cms.paisaonsalary.in/').'public/images/LAST-DAY.png" alt="LAST DAY"></td>
                                                    </tr>';
            } else {
                $message .= '<tr>
                                                        <td class="left-banner"><img src="'.(getenv("WEBSITE_URL") ?? 'https://cms.paisaonsalary.in/').'public/images/friend_backend.jpg" alt="Frindly Reminder"></td>
                                                        <td class="right-banner"><img src="'.(getenv("WEBSITE_URL") ?? 'https://cms.paisaonsalary.in/').'public/images/' . $days . '-DAYS.png" alt="' . $days . ' DAYS"></td>
                                                    </tr>';
            }
