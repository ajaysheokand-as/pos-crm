...
$pdf->Output($file_path_with_name, 'F');
    ...
    public function sendSanctionMail($lead_id) {
        ...
        $letter_hedder = base_url()."public/emailimages/AMAN FINCAP H.png";
        $letter_footer = base_url()."public/emailimages/AMAN FINCAP F.png";
...
//          <img src='".$letter_hedder."' width='100%'>
...
//          </p>
//          <p style='text-align:justify'>
//             <span style='font-size:12.0pt;color:black'>Dear {{Name of the Customer}},</span>
//          </p>
//          <p style='text-align:justify'>
//             <span style='font-size:12.0pt;color:black'>Sub:&nbsp; <b>
//             <u>Short Term Loan from Aman Fincap Limited.</u>
//             </b>
//             </span>
//          </p>
//          <p style='text-align:justify'>
//             <span style='font-size:12.0pt;color:black'>With reference to your application dated&nbsp;{{Date of Application}}&nbsp;for a Short Term Loan, we have the pleasure of sanctioning you an amount of&nbsp; <strong>Rs. {{Loan Amount }}</strong>&nbsp;(in figures) (in words) {{amount in Words}}.subject to the following terms and conditions: </span>
//          </p>
//          <p style='margin-left:28.35pt;text-align:justify;text-indent:-10.35pt'>
//             <span style='font-size:12.0pt;color:black'>1. <span style='font:7.0pt '>&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;color:black'>Loan Amount</span>
//             </b>
//             <span style='font-size:12.0pt;color:black'> :    {{Loan Amont}}</span>
//          </p>
//          <p style='margin-left:28.35pt;text-align:justify;text-indent:-10.35pt'>
//             <span style='font-size:12.0pt;color:black'>2. <span style='font:7.0pt '>&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;color:black'>Interest Rate: {{Rate of Interest}}</span>
//             </b>
//          </p>
//          <p style='text-align:justify'>
//             <span style='font-size:12.0pt;color:black'>As of effective date, the Schedule of interest and the charges are as follows:</span>
//          </p>
//          <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=652 style='width:100%;border-collapse:collapse;border:none'>
//             <tr>
...
//                      normal'>
//                      <b>
//                      <span style='font-size:12.0pt;color:black'>{{Rate of Interest}}</span>
//                      </b>
//                      <b>
//                      <span style='font-size:12.0pt;color:black'>.% per day from the date of disbursal until the date of repayment. In the event of failure to make payment on due date, a penal interest of {{Penal Interest
//                      rate}}% per day shall be applicable from the due date until the date of payment.</span>
//                      </b>
//                   </p>
//                </td>
//             </tr>
...
//                      <b>
//                      <span style='font-size:12.0pt;
//                         color:black'>Lender will charge a processing fee of INR {{Net Processing
//                      Fees}} plus applicable taxes.</span>
//                      </b>
//                   </p>
//                </td>
//             </tr>
...
//                      <b>
//                      <span style='font-size:12.0pt;
//                         color:black'>In case of delay in payment of amount due, late fee charges shall be INR {{Penal Interest}}.% of the loan amount, whichever is higher.</span>
//                      </b>
//                   </p>
//                </td>
//             </tr>
...
//          </table>
//          <p style='text-align:justify'>
//             <span style='font-size:12.0pt;color:black'>The Lender, may at its sole discretion, waive or reduce the charges as mentioned above, on a case to case basis.</span>
//          </p>
//          <p>
//             <span style='font-size:12.0pt;color:black'>For any queries, you may write to us at&nbsp;</span>
//             <a href='mailto:info@amanfincap.com'>
//             <span style='font-size:
//                12.0pt'>info@amanfincap.com</span>
//             </a>
//             <span style='font-size:12.0pt;color:black'> ,&nbsp;</span>
//             <a href='mailto:grievanceredressal@amanfincap.com'>
//             <span style='font-size:12.0pt'>grievanceredressal@amanfincap.com</span>
//             </a>
...
//          <img src='".$letter_footer."' width='100%'>
//       </div>
//       <!-- SANCTION LETTER END -->
...
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>{{Name of the customer}}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>{{Purpose of Loan}}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>{{APR}} % p.a. which shall comprise of;</span>
//                   </p>
...
//                      </span>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>Fixed Rate of Interest : {{Rate of Interest}} % on a daily basis; + (plus);</span>
//                   </p>
...
//                      </span>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>Processing fee : {{Net Processing Fee}} (one time, non-refundable fee levied for processing and grant of loan, Taxes and Levies as applicable);</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>INR {{Disbursal Amount}} after deduction of Processing Fee;</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>INR {{Repayment Amount}}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>{{Repayment date}}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>
//                      <br> Borrowers can refer to Grievance Redressal Policy at  https://tejasloan.com/privacy-policy </span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>
//                      <br> Email:&nbsp;grievance@tejasloan.com </span>
//                      <a href='../../../../../ADMIN/Downloads/grievance@paymeindia.in'>../../../../../ADMIN/Downloads/grievance@paymeindia.in</a>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>
//                      <br>
...
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>
//                      <br> Email:&nbsp;info@tejasloan.com <br>
...
//                      <br> Email:&nbsp; </span>
//                      <a href='mailto:grievanceredressal@amanfincap.com'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>grievanceredressal@amanfincap.com</span>
//                      </a>
//                   </p>
//                   <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//                      <a href='../../../../../ADMIN/Downloads/grievance@paymeindia.in'>../../../../../ADMIN/Downloads/grievance@paymeindia.in</a>
...
//                      <span style='font-size:12.0pt;font-family:sans-serif'>grievance.nodal@amanfincap.com</span>
//                      </a>
//                      <a href='../../../../../ADMIN/Downloads/grievance@paymeindia.in'>../../../../../ADMIN/Downloads/grievance@paymeindia.in</a>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>
...
//                      line-height:normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif;
//                         color:black'>{{Repayment Amount}}</span>
//                   </p>
//                </td>
//             </tr>
//          </table>
...
//             <a href='mailto:info@amanfincap.com,%20%20%20%20grievanceredressal@amanfincap.com'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>info@amanfincap.com,    grievanceredressal@amanfincap.com</span>
//             </a>
//             <u>
//             <span style='font-size:12.0pt;
...
//          </p>
//          <p class=MsoNormal style='margin-bottom:0in;line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>&nbsp;</span>
//          </p>
//          <img src='".$letter_footer."' width='100%'>
//       </div>
...
//                color:black'>b) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The disbursement of the Loan shall be made by the Lender either in a single lump sum or in such instalments as the Lender may determine at its sole discretion.</span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
...
//                color:black'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower shall, upon request by the Lender, acknowledge the receipt of each disbursed amount by executing a receipt or any other document in a form acceptable to the Lender.</span>
//          </p>
//          <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//             normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif;
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.1 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Payment of Instalments and Bullet Payments</span>
//             </b>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower shall pay to the Lender all Instalments and/or bullet payments (inclusive of Interest), strictly on a monthly basis, on the Scheduled Due Dates, beginning from the first due date and continuing through to the last due date as stipulated in the Sanction Letter cum Key Fact Statement (“Sanction Letter cum KFS”). Time shall be of the essence for such payments. All payments shall be made through Repayment Instruments issued by the Borrower in favor of the Lender.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>d) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower shall not instruct or request the Lender to withhold or delay the presentation of any Repayment Instrument. Any delay or failure by the Lender or its Service Provider in presenting a Repayment Instrument shall not affect or defer the Borrower’s liability to make timely payments.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.2 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Dishonor of Repayment Instruments</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:
//                sans-serif'>
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.3 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Return or Disposal of Repayment Instruments upon Foreclosure</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.4 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Right to Recall in Case of Misrepresentation</span>
//             </b>
//             <span style='font-size:12.0pt;
//                font-family:sans-serif'>
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.5 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Repayment to Collection Account</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.6 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Corporate Borrower – Change in Authorized Signatories</span>
//             </b>
//             <span style='font-size:
//                12.0pt;font-family:sans-serif'>
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>3.7 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Appointment of Agent</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower shall execute, in favor of the Lender, a <b>Demand Promissory Note</b> and such other documents as may be required by the Lender, in a form approved by the Lender, covering the full amount of the Loan along with applicable interest. </span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Any security provided or created by the Borrower under this Agreement and/or any other Loan Documents shall constitute <b>continuing security</b>, remaining in full force and effect until the entire Outstanding Balance and all other dues payable under the Loan Documents are fully repaid and discharged to the satisfaction of the Lender. </span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>4.3 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Each security interest created under this Agreement or any other Loan Document shall be in addition to, and not in substitution of, any other security, guarantee, lien, indemnity, undertaking, or right that the Lender presently holds or may hold in the future, whether under law or otherwise, in relation to the Outstanding Balance or any part thereof.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>4.4 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The security created under this Agreement or any other Loan Document shall not be merged with, and shall not exclude or be prejudiced by, any other security interest, right of recourse, or remedy (including the invalidity thereof) that the Lender presently holds or may acquire in the future in respect of the Borrower or any other person liable for repayment of the Outstanding Balance.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>4.5 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The security interest created or to be created in favor of the Lender shall be released only upon full repayment of the Outstanding Balance and settlement of all dues and obligations owed by the Borrower, whether under this Agreement or otherwise, including any obligations owed by the Borrower to affiliates or group companies of the Lender.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>4.6 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Upon occurrence of an Event of Default, and without prejudice to any other rights or remedies available to the Lender under applicable law or the Loan Documents, the Lender shall have the right to:</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>e) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Declare the entire Outstanding Balance, whether due or payable at such time or not, as <b>immediately due and payable</b>; </span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>f) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Exercise any and all powers and rights available under the Loan Documents or under applicable law;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>g) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Undertake any action permitted, expressly or impliedly, by the Loan Documents or applicable legal provisions.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>4.7 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower acknowledges that the powers granted to the Lender under this clause are for <b>valuable consideration</b>, are <b>coupled with interest</b>, and shall accordingly be <b>irrevocable</b> for as long as any portion of the Outstanding Balance remains unpaid. </span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>4.8 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The enforcement of any security interest by the Lender shall not affect the Borrower's continuing liability to the Lender for any <b>shortfall or deficiency</b> arising or continuing under this Agreement or any of the Loan Documents in respect of the Outstanding Balance. </span>
//          </p>
//          <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//             normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif;
...
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>a) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Change in Contact and Banking Details</span>
//             </b>
//             <span style='font-size:12.0pt;
...
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Change in Employment / Occupation</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>a) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Provide the name and address of the new employer, business, and/or professional establishment;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
...
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Prohibited Use of Loan</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>: Not utilize any part of the Loan amount for illegal activities, immoral purposes, gambling, betting, lottery, races, speculative trading, or any activity of a similar prohibited or unethical nature.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
...
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Regulatory Compliance</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>: Obtain and submit all requisite permissions, consents, and approvals to the Lender and/or its service providers, as may be required under applicable law or internal policy, prior to the disbursement of the Loan.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
...
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Acknowledgement of Terms</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>: Acknowledge having read and understood all terms and conditions, privacy policy, and relevant documents made available on the websites of both Tejas Loan (hereinafter referred to as “Tejas Loan”) and the Lender.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
...
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Acceptance of Online Terms</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>: Unconditionally agree to comply with all the terms and conditions, privacy policy, and other legally binding content published on the websites of Tejas Loan and the Lender, as may be updated from time to time.</span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>h) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Accuracy of Information</span>
//             </b>
//             <span style='font-size:12.0pt;font-family:sans-serif'>: Confirm that all personal, financial, and employment-related information provided to Tejas Loan and the Lender is true, accurate, and complete in all respects. The Borrower undertakes to immediately inform the Lender of any change or inaccuracy discovered.</span>
//          </p>
//          <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
...
//             <span style='font-size:12.0pt;font-family:sans-serif'> Loan Documents executed and obligations undertaken by the Borrower are valid, binding, and enforceable in accordance with their terms and do not contravene any applicable laws, regulations, or existing contractual obligations of the Borrower.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>b) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The execution, delivery, and performance of the Loan Documents by the Borrower do not and will not:</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>i. <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>violate any applicable law, regulation, or judicial or governmental order;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>ii. <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>result in a breach or constitute a default under any agreement or instrument to which the Borrower is a party or by which the Borrower or its assets are bound;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>iii. <span style='font:7.0pt '>&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>cause the creation or imposition of any encumbrance on the Borrower’s assets, except as permitted under the Loan Documents;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>iv. <span style='font:7.0pt '>&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Contravene any provision of the Borrower’s constitutional or governing documents (where applicable).</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>There are no actions, suits, proceedings, or investigations pending or, to the Borrower’s knowledge, threatened against the Borrower before any court, tribunal, or governmental authority that could materially affect the Borrower’s financial position, the enforceability of the Loan Documents, or the Borrower’s ability to perform its obligations thereunder.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>d) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Notwithstanding the Repayment Schedule or Loan Tenure, the Lender shall be entitled to demand immediate repayment of the Loan and all Outstanding Balances at any time. Upon such demand, the Borrower shall make immediate payment, and the Lender may adjust any monies lying in any account of the Borrower with the Lender or its branches towards such outstanding dues.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>e) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Repayment Instruments and Mandates:</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>i. <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower has issued Repayment Instruments with full knowledge that dishonour of the same constitutes an offence under the Negotiable Instruments Act, 1881, and/or the Payment and Settlement Systems Act, 2007, as applicable.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>ii. <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>No notice shall be required for the presentation of such instruments.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>iii. <span style='font:7.0pt '>&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower may authorize payment via direct debit, NACH/ECS, or similar mandates from an Approved Bank account.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>g) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower shall at all times comply with all applicable laws in India, including but not limited to the Prevention of Money Laundering Act, 2002.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>h) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower is competent to contract and has taken all necessary steps and obtained requisite authorizations to enter into and perform the Loan Documents.</span>
//          </p>
//          <img src='".$letter_footer."' width='100%'>
//          <br><br>
//          <img src='".$letter_hedder."' width='100%'>
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>i) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>All information, financial or otherwise, provided by the Borrower is true, complete, and not misleading in any material respect as of the date provided and remains valid unless updated or withdrawn in writing.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>j) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower is not insolvent, bankrupt, in receivership, or under liquidation and has not taken any steps toward such proceedings.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>k) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower confirms that they fully understand the English language and agrees that all communication from the Lender in English shall be binding.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>l) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower has obtained all applicable statutory approvals and consents necessary to execute the Loan Documents and perform obligations thereunder.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>m) <span style='font:7.0pt '></span>
//             </span>
//             <span style='font-size:
//                12.0pt;font-family:sans-serif;color:black'>The</span>
//             <span style='font-size:12.0pt;font-family:sans-serif'> Borrower confirms that he/she is gainfully employed at the time of execution of the Loan Documents, is not under notice or intending to resign. In case of resignation, termination, or change in employment, the Borrower shall promptly notify the Lender.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>n) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower has duly filed all required tax returns and paid all applicable taxes, including stamp duty on Loan Documents, except where disputes are pending in good faith and proper reserves have been made.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Creditworthiness and Non-Default <br> The Borrower affirms that they: </span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>i. <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>are not identified as a willful defaulter;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>ii. <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>are not listed on the Reserve Bank of India’s caution lists or defaulters' databases;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-align:justify;text-indent:-14.15pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>iii. <span style='font:7.0pt '>&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>are not involved in any activities or investigations concerning terrorism, anti-national behavior, or enforcement proceedings by any statutory authority.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Undertaking on Lender Policies <br> The Borrower undertakes to keep themselves updated with the Lender's policies and terms from time to time and agrees to abide by the same. </span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Regular Payments <br> The Borrower warrants timely and regular payments to the Lender as per the terms of the Loan Documents. </span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Authority of Signatories (If Applicable) <br> Where the Borrower is an entity (proprietorship, partnership, LLP, or company), all signatories to the Loan Documents are duly authorized to execute the same on behalf of the Borrower. </span>
//          </p>
//          <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//             normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif;
...
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
//             <span style='font-family:sans-serif'>8.1 <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif;
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>a) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'> any personal, financial, or credit-related information and data relating to the Borrower;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>b) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>information or data relating to the Loan and/or any credit facility availed or to be availed by the Borrower from the Lender;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>information regarding any obligations undertaken or to be undertaken by the Borrower in relation to such credit facilities;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>d) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Information regarding any default or non-compliance by the Borrower in the discharge of any of the aforesaid obligations.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower declares and affirms that all information and data provided by the Borrower to the Lender, whether submitted in writing or communicated orally, is true, complete, accurate, and not misleading in any respect.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:28.35pt;text-align:justify;text-indent:-28.35pt;
//             line-height:normal'>
...
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Borrower further agrees and acknowledges that:</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>b) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>CIBIL and/or such other authorized agency may furnish, for consideration, the processed information or any reports, scores, or products derived therefrom to banks, financial institutions, credit grantors, or other registered users, as permitted under applicable law and regulations;</span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Notwithstanding anything to the contrary contained in this Agreement, the Loan Documents, or any applicable law, the Borrower agrees that in the event of default in repayment of the Loan, any instalment thereof, or any part of the Outstanding Balance on the Scheduled Due Date(s), the Lender and/or the Reserve Bank of India shall have an unqualified right to disclose, report, or publish the name of the Borrower as a “defaulter” in such manner and through such media as they may, in their sole discretion, deem appropriate.</span>
//          </p>
//          <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//             normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif;
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>Unless the context otherwise requires or unless expressly stated to the contrary, in this Agreement:</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>a) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>References to “Articles”, “Sections”, or “Schedules” are to the Articles, Sections, and Schedules of this Agreement and shall be deemed to include all amendments and modifications thereto</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>b) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>References to any law, statute, regulation, or provision thereof shall include such law, statute, regulation, or provision as amended, re-enacted, substituted, or supplemented from time to time.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The headings and titles used in this Agreement are for reference and convenience only and shall not affect the construction or interpretation of any provision of this Agreement.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>d) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>Words denoting the singular shall include the plural and vice versa, as the context may require.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>e) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>References to any gender shall include all genders—male, female, and neuter—as the context may require.</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>f) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>The Sanction Letter cum Key Fact Statement (KFS), all Schedules, and the Recitals form an integral and binding part of this Agreement and shall be read in conjunction with the provisions hereof.</span>
//          </p>
//          <br><br>
//          <img src='".$letter_footer."' width='100%'>
//          <br><br>
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>a) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>to the Lender’s affiliates, group companies, or subsidiaries;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>b) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>to any actual or prospective transferees, assignees, or purchasers of any rights, obligations or interests in the Loan and/or the Outstanding Balance;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>c) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>to any regulatory, governmental, judicial, statutory, or quasi-judicial authority, including but not limited to disclosures made in compliance with any law, rule, regulation, directive, order, notification or instruction issued by the Reserve Bank of India or any other governmental authority;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>d) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>in connection with the exercise of the Lender’s rights, remedies, powers, or obligations under the Loan Documents;</span>
//          </p>
//          <img src='".$letter_footer."' width='100%'>
//          <br><br>
//          <img src='".$letter_hedder."' width='100%'>
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>e) <span style='font:7.0pt '>&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>to the Lender’s employees, directors, officers, advisors, agents, consultants, service providers and/or subcontractors, on a need-to-know basis, for the purpose of fulfilling the Lender’s obligations under the Loan Documents, or for evaluating or pursuing any business relationship with the Borrower;</span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:42.55pt;text-align:justify;text-indent:-14.2pt;
//             line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>f) <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'> to any credit information bureau, credit rating agency, data repository, or other service providers or agencies engaged by the Lender.</span>
//          </p>
//          <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
...
//             <span style='font-size:12.0pt;font-family:sans-serif'>In addition to the above, the Lender shall have the right to disclose, without prior notice to the Borrower, all or any information or documentation, including but not limited to:</span>
//          </p>
//          <p class=MsoListParagraphCxSpFirst style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:1.0in;text-indent:-29.45pt;line-height:normal'>
//             <span style='font-size:12.0pt;font-family:Symbol'>· <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>personal and financial information and data relating to the Borrower;</span>
//          </p>
//          <p class=MsoListParagraphCxSpMiddle style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:1.0in;text-indent:-29.45pt;line-height:normal'>
//             <span style='font-size:12.0pt;font-family:Symbol'>· <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>details of any credit facility availed or proposed to be availed by the Borrower;</span>
//          </p>
//          <p class=MsoListParagraphCxSpLast style='margin-top:0in;margin-right:0in;
//             margin-bottom:0in;margin-left:56.7pt;text-indent:-14.15pt;line-height:normal'>
//             <span style='font-size:12.0pt;font-family:Symbol'>· <span style='font:7.0pt '>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
//             </span>
//             <span style='font-size:12.0pt;font-family:sans-serif'>any default or delay in repayment, or any other non-compliance with the terms of the Loan Documents;</span>
//          </p>
//          <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
//             margin-left:42.55pt;text-align:justify;text-indent:.5pt;line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>to any governmental, taxation, regulatory or judicial authority or agency, including but not limited to the Income Tax Department, Credit Rating Agencies, Credit Information Companies (CICs), or any other authority, body, or department, for the purpose of compliance, regulatory reporting, or protection of the Lender’s interests.</span>
//          </p>
//          <p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
//             margin-left:42.55pt;text-align:justify;text-indent:.5pt;line-height:normal'>
//             <span style='font-size:12.0pt;font-family:sans-serif'>&nbsp;</span>
...
//                      <b>
//                      <u>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>S.NO.</span>
//                      </u>
//                      </b>
//                   </p>
//                </td>
...
//                      <b>
//                      <u>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>PARTICULAR</span>
//                      </u>
//                      </b>
//                   </p>
//                </td>
...
//                      <b>
//                      <u>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>DETAILS</span>
//                      </u>
//                      </b>
//                   </p>
//                </td>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>1.</span>
//                   </p>
//                </td>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Date of Execution</span>
//                   </p>
//                </td>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ Sanction Date }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>2.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Place of Execution</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ City }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>3.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Name of the Lender</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Aman Fincap Limited</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Name of the Service Provider</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Naman Finlease Pvt Ltd.</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Name of the DLA</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Tejas Loan</span>
//                   </p>
//                </td>
//             </tr>
//         </table>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>4.</span>
//                   </p>
//                </td>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Name of the Borrower</span>
//                   </p>
//                </td>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{Customer Name}}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>5.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Address of the Borrower</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ Address of the Customer }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>6.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Name of the Employer</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ Employer name }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>7.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Address of the Employer</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ Employer address }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>8.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Reference number of Sanction Letter cum KFS</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ Loan Account Number }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>9.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Date of Execution of Sanction Letter cum KFS</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ Date_of_sanction_letter }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>10.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Bank Account Details</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>{{ bank Account Number }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>11.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Sanctioned Loan Amount</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>INR {{ Loan Recommended }}</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>12.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Interest Rate</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Interest on the Loan: Interest on the Loan: {{ interest }}% from the date of disbursal until the date of repayment. In the event of failure to make payment on due date, a penal interest of {{ penal_interest }}% shall be applicable from the due date until the date of payment.</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>13.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Processing Fee</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>A processing fee, {{processing fee }}% of the loan amount + applicable taxes.</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>14.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Late Fee</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>In case of delay in payment of Amount Due, Lender shall charge late payment charges of double of Interest rates. </span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>15.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Maximum Interest Rate</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>The Interest rate on the Loan shall not exceed 50% per Month.</span>
//                   </p>
//                </td>
//             </tr>
//             <tr>
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>16.</span>
//                   </p>
//                </td>
//                <td width=165 style='width:123.85pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>Cooling Period</span>
//                   </p>
//                </td>
//                <td width=459 style='width:343.9pt;border-top:none;border-left:none;
//                   border-bottom:solid #DDDDDD 1.0pt;border-right:solid #DDDDDD 1.0pt;
...
//                   <p class=MsoNormal style='margin-bottom:0in;text-align:justify;line-height:
//                      normal'>
//                      <span style='font-size:12.0pt;font-family:sans-serif'>3 days</span>
//                   </p>
//                </td>
//             </tr>
//          </table>
...
// </html>";
        ...
        $directSanctionLetter = "https://crm.tejasloan.com/direct-document-file/" . $cam_sanction_letter_file_name;
    ...
    public function generateSanctionLetter($lead_id) {
        ...
        try {
            ...
            //                 <td bgcolor = "#FFFFFF"><b>(II)</b></td>
            //                 <td bgcolor = "#FFFFFF">Loan Amount</td>
            //                 <td bgcolor = "#FFFFFF">&#8377;&nbsp;' . number_format(round($loan_recommended, 0), 2) . '</td>
            //             </tr>
            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(III)</b></td>
            //                 <td bgcolor = "#FFFFFF">ROI (in % per day)</td>
            //                 <td bgcolor = "#FFFFFF">' . $roi . '</td>
            //             </tr>

            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(IV)</b></td>
            //                 <td bgcolor = "#FFFFFF">Total interest charge during the entire Tenure of the loan</td>
            //                 <td bgcolor = "#FFFFFF">&#8377;&nbsp;' . number_format(round((($loan_recommended * $roi * $tenure) / 100), 0), 2) . '</td>
            //             </tr>
            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(V)</b></td>
            //                 <td bgcolor = "#FFFFFF">Processing Fee (Including 18% GST)</td>
            //                 <td bgcolor = "#FFFFFF">&#8377;&nbsp;' . number_format(round($admin_fee, 0), 2) . '</td>
            //             </tr>
            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(VI)</b></td>
            //                 <td bgcolor = "#FFFFFF">Insurance charges, if any (in &#8377;)</td>
            ...
            //                 <td bgcolor = "#FFFFFF"><b>(VIII)</b></td>
            //                 <td bgcolor = "#FFFFFF">Net disbursed amount</td>
            //                 <td bgcolor = "#FFFFFF">&#8377;&nbsp;' . number_format(round($net_disbursal_amount, 0), 2) . '</td>
            //             </tr>
            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(IX)</b></td>
            //                 <td bgcolor = "#FFFFFF">Total Repayment Amount</td>
            //                 <td bgcolor = "#FFFFFF">&#8377;&nbsp;' . number_format(round($repayment_amount, 0), 2) . '</td>
            //             </tr>
            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(X)</b></td>
            //                 <td bgcolor = "#FFFFFF" style="width:min-content">Annual Percentage Rate - Effective Daily interest rate (in %)
            //                     (Considering the ROI of ' . $roi . '% per day)</td>
            //                 <td bgcolor = "#FFFFFF">' . $annual_percent_rate . '</td>
            //             </tr>
            //             <tr>
            //                 <td bgcolor = "#FFFFFF"><b>(XI)</b></td>
            //                 <td bgcolor = "#FFFFFF">Tenure of the Loan (days)</td>
            ...
            //                 <td bgcolor = "#FFFFFF"><b>(XV)</b></td>
            //                 <td bgcolor = "#FFFFFF">
            //                     Rate of Daily penal charges in case of delayed payments
            //                         (if any)
            //                 </td>
            //                 <td bgcolor = "#FFFFFF">
            //                     Double the <strong>(III)</strong>
            ...
            //                 <td bgcolor = "#FFFFFF"><b>(XVII)</b></td>
            //                 <td bgcolor = "#FFFFFF">
            //                     Name, designation, Address and phone number of nodal 
            //                     grievance redressal officer designated specifically to deal with 
            //                      FinTech/ digital lending related complaints/ issues
            //                 </td>
            //                 <td bgcolor = "#FFFFFF">
            //                     <p>'. NBFC_NODEL_GRIEVANCE_REDRESSAL_OFFICER_NAME .'</p>
            //                     <p>Mobile: '. NBFC_NODEL_GRIEVANCE_REDRESSAL_OFFICER_NUMBER .'</p>
            //                     <p>Address: '. NBFC_ADDRESS .'</p>
            //                 </td>
            //             </tr>
            //         </table>
            //         <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
            //         <br/><br/><br/><br/><br/><br/>
            //         <table width="100%" border="0" cellpadding="1" cellspacing="1" align="center" style="font-family:Arial, Helvetica, sans-serif; line-height:17px; font-size:13px; border:solid 1px #ddd; padding:0px 7px;">
            //             <tr width="100%">
            //                 <td colspan="2" valign="middle"><p style="font-size: 18px; color: #0363a3; font-size:18px;"><img src="' . $letterhead_url . '" alt="Sanctionletter-header" width="100%" height="100%" border="0" usemap="#Map" /></td>
            //             </tr>
            //             <tr>
            //                 <td align="right" style="text-align:right;"><span style="color: #0363a3; font-size:16px;">Date : ' . $sanction_date . '</span></td>
            //             </tr>
            //             <tr>
            //                 <td><strong>To,</strong></td>
            //                 <td>&nbsp;</td>
            ...
            //             <tr>
            //                 <td colspan="2">Thank you for  showing your interest in '. PORTAL_DOMAIN .' and giving us an opportunity to serve  you.</td>
            //             </tr>
            //             <tr>
            //                 <td colspan="2">We are pleased  to inform you that your loan application has been approved as per the below  mentioned terms and conditions. </td>
            //             </tr>
            //             <tr>
            //                 <td colspan="2"><strong>'. PORTAL_DOMAIN .',  a brand name under '. NBFC_NAME .' (RBI approved NBFC – Reg No.'. NBFC_CIN .')  <br>'. NBFC_ADDRESS .'</strong></td>
            //             </tr>
            //             <tr>
            //                 <td colspan="2">This sanction will be subject to the following Terms and Conditions:</td>
            //             </tr>
            ...
            //                         </tr>
            //                         <tr>
            //                             <td align = "left" valign = "middle" bgcolor = "#FFFFFF"><strong>Late Payment Charges(%) per day</strong></td>
            //                             <td align = "center" valign = "middle" bgcolor = "#FFFFFF"><strong>:</strong></td>
            //                             <td align = "left" valign = "middle" bgcolor = "#FFFFFF">' . round(($roi * 2), 2) . ' </td>
            //                         </tr>
            //                         <tr>
            ...
            //                         </tr>
            //                         <tr>
            //                             <td align = "left" valign = "middle" bgcolor = "#FFFFFF"><strong>Annual Percentage Rate (%)</strong></td>
            //                             <td align = "center" valign = "middle" bgcolor = "#FFFFFF"><strong>:</strong></td>
            //                             <td align = "left" valign = "middle" bgcolor = "#FFFFFF">' . $annual_percent_rate . '</td>
            //                         </tr>
            //                     </table>
            ...
            //             </tr>
            //             <tr>
            //                 <td colspan = "2"><strong style = "color:#0363a3;">Team '. PORTAL_DOMAIN .'</strong></td>
            //             </tr>
            //             <tr>
            //                 <td colspan = "2"><strong style = "color:#0363a3;">(Brand Name for '. NBFC_NAME .')</strong></td>
            //             </tr>
            //             <tr>
            //                 <td colspan = "2"><strong>Kindly Note:</strong></td>
            //             </tr>
            ...
            //             </tr>
            //             <tr>
            //                 <td colspan = "2">You can Prepay/Repay the loan amount using our link <a href = "'. PORTAL_REDIRECTION_URL['REPAY_LOAN'] .'" target = "_blank" style = "color:#0363a3; text-decoration:blink;">'. PORTAL_REDIRECTION_URL['REPAY_LOAN'] .'</a></td>
            //             </tr>
            //             <tr>
            //                 <td colspan = "2"><img src = "' . $letterfooter_url . '" alt = "Sanctionletter-footer.jpg" width = "760" height = "104"></td>
            //             </tr>
            ...
            //                 <li  style="color:#2E2E2E;margin-bottom:0in;line-height:150%; background:white"><span  style="font-size:10.0pt;line-height:150%;font-family:Arial, Helvetica, sans-serif;">If repayment is not done by the specified date, the Borrower will be liable for Late Payment Charges.</span></li>
            //                 <li  style="color:#2E2E2E;margin-bottom:0in;line-height:150%; background:white"><span  style="font-size:10.0pt;line-height: 150%;font-family:Arial, Helvetica, sans-serif;">If any repayment cheque is not honored, the Borrower will be liable for dishonor charges and Late Payment Charges.</span></li>
            ...
            //                 <li  style="color:#2E2E2E;margin-bottom:0in;line-height:150%; background:white"><span  style="font-size:10.0pt;line-height: 150%;font-family:Arial, Helvetica, sans-serif;">Any overdue payment incurs interest at the Late Payment Charges rate (which is higher than the usual interest rate). We may change the interest rate if required by the statutory/regulatory authority.</span></li>
                    ...
                    <html xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <body>
                            <table width="550" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #0463a3;">
                                <tr>
                                    <td><a href="' . WEBSITE_URL . '" target="_blank"><img src="' . EMAIL_BRAND_LOGO . '" alt="tejasloan-logo" style="border-radius: 11px;padding: 6px 8px;"></a></td>
                                </tr>
                                <tr>
                                ...
                                <div style="max-width: 600px; margin: 20px auto; background: #ffffff; border: 1px solid #ddd; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); overflow: hidden;">
                                    ...
                                    <div style="padding: 20px;">
                                        <div style="text-align: center; margin-bottom: 20px;">
                                            <img src="https://tejasloanbucket.s3.ap-south-1.amazonaws.com/emailer/' . $repayment_link . '" alt="Payment Reminder Banner" style="width: 100%; max-width: 560px; border-radius: 8px;">
                                        </div>
