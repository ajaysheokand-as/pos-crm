       ...
       error_reporting(E_ALL);
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // if (!empty($token_verification['status'])) {
                ...
                $repayment_type = $post['repayment_type'];
                $ip = $post['ip'];
                ...
                $imgUrl = $image_name . "." . "png";
                $image_upload_dir = "/home/devmunitechuat/public_html/upload/" . $imgUrl;

                $res = move_uploaded_file($_FILES['file']['tmp_name'], $image_upload_dir);
                ...
                $return_data['save_status'] = $result;
