...
//                html += '<tr><th class="thbg">Advance IRR Amount (Rs.)</th><td>' + ((res.cam_interest_amount) ? res.cam_interest_amount : "-") + '</td><th class="thbg"></th><td></td></tr>';
                ...
                html += '<tr><th class="thbg">Senction Email Sent On</th><td>' + ((res.agrementRequestedDate) ? res.agrementRequestedDate : '-') + '</td><th class="thbg">Senction Email Sent To</th><td>' + ((res.email) ? res.email : '-') + '</td></tr>';
                html += '<tr><th class="thbg">Senction Email Delivery status</th><td>' + ((res.loanAgreementRequest == 1) ? "SENT" : 'PENDING') + '</td><th class="thbg">Senction Email Response status</th><td>' + ((res.loanAgreementResponse == 1) ? "ACCEPTED" : '-') + '</td></tr>';
                html += '<tr><th class="thbg">Senction Email Response IP</th><td>' + ((res.agrementUserIP) ? res.agrementUserIP : "-") + '</td><th class="thbg">Acceptance Email</th><td>' + ((res.loanAgreementResponse == 1) ? res.email : '-') + '</td></tr>';
