...
class Task_Model extends CI_Model {
    ...
    public function index($conditions = null, $limit = null, $start = null, $search_input_array = array(), $where_in = array()) {
        ...
        $select .= ' C.customer_religion_id, religion.religion_name, C.father_name, branch.m_branch_name, C.aadhar_no, C.customer_digital_ekyc_flag, ';
                ...
                $data .= '
                        <tr>
                            ...
                            <td class="whitespace"><div class="tooltip"><i class="fa fa-comment"></i><span class="tooltiptext">
                                    <b>Remarks Collection : </b><i>' . $row->remarks . '</i><br/>
                                    <b>Remarks Closure : </b><i>' . $row->closure_remarks . '</i>
                                    </span></div></td>
                            ...
                            <td class="whitespace">' . $repaymentstatus->status_name . '</td>
                            <td class="whitespace">' . $payment_verification . '</td>
                            <td class="whitespace">' . $row->collection_executive_name . '</td>
                            ...
                            <td class="whitespace">' . (($row->closure_user_name == null) ? '-' : $row->closure_user_name) . '</td>
