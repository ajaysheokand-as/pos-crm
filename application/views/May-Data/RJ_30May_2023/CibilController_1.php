...
//        }
    ...
    //     $datafile = $filename . PHP_EOL ;
      
    //     $fp = fopen(base_url().'/views/cibil_score_pdf.php', 'w');
    //     $cibilFile = fwrite($fp, $datafile);
    //   //  print_R($cibilFile); die;
    ...
    //     fclose($fp);
        ...
        $data = $this->getCibilFile($cibil_id);
        $filename = $data['cibil_file'];
        file_put_contents(APPPATH . "/views/cibil_score_pdf.php", $filename);
